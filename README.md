# Vue3职业院校数字基座管理系统
                                                                简介
数字底座是一款专为大型政府及企业数字化转型，以及职业院校数字基座中职数据标准及接口规范而设计的产品。它以前称为“全国职业教育智慧大脑院校中台中职数据标准及接口规范”，以下简称为“规范”。该产品旨在落实《中国教育现代化2035》的要求，重点服务于职业教育的数字化转型和职业院校的数字校园建设。其主要职责是保障职业教育领域中的教育教学、教育管理等基础业务数据的汇聚、共享和交换，并确保数据的一致性与准确性。

该规范在整合现行国家标准和教育行业标准的基础上，对其中高频、通用和核心的数据元素进行了提炼，形成了中等职业院校数据标准规范。这不仅能够有效提升数据质量，还能理清数据构成，打破数据孤岛，加快数据流通，并释放数据价值。

教育数字化是数字中国战略的关键组成部分，同时也是推动教育强国建设的重要战略支撑。教育部在《关于加强新时代教育管理信息化工作的通知》中明确提出，要利用新一代信息技术提升教育管理的数字化、网络化和智能化水平，推动教育决策从经验驱动转向数据驱动，教育管理从单向管理转向协同治理，教育服务从被动响应转向主动服务。国务院在《“十四五”数字经济发展规划》中也强调了“深入推进智慧教育”的必要性，提出了推进教育新型基础设施建设、深入开展智慧教育示范区建设，并推动“互联网+教育”健康发展的具体要求。《教育部2022年工作要点》也提出了“实施教育数字化战略行动”，以加快教育数字化转型和智能升级的步伐。数据体系建设正是实现这一教育数字化战略的核心内容。
