  ...
  <div class="award-textbook-management">
    ...
    <el-card class="table-card" shadow="never">
      <div class="table-header">
        ...
        <div class="header-title">获奖教材数据编码管理</div>
...
import {
  ...
  type OdsHjjcsjInfo,
  type DictOption,
} from "@/api-code/code/code_base/zygjx/ods_hjjcsj";
import { getOdsJcjbsjOptions } from "@/api-code/code/code_base/zygjx/ods_jcjbsj";
