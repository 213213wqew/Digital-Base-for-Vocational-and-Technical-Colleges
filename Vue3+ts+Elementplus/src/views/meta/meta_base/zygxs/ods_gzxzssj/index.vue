  ...
  <div class="professional-certificate-management">
    ...
    <el-card class="table-card" shadow="never">
      <div class="table-header">
        ...
        <div class="header-title">1+X证书数据管理</div>
...
import {
  ...
  getSelectOptions,
  getZyhOptions,
} from "@/api/meta/meta_base/zygxs/ods_gzxzssj";
import type { OdsGzxzssjInfo, OdsGzxzssjQuery } from "@/api/meta/meta_base/zygxs/ods_gzxzssj";
