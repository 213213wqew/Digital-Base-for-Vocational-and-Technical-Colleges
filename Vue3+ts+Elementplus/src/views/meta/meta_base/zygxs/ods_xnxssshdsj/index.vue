...
import {
  ...
  exportOdsXnxssshdsj,
  type DictOption
} from "@/api/meta/meta_base/zygxs/ods_xnxssshdsj";
import type { OdsXnxssshdsjInfo, OdsXnxssshdsjForm, OdsXnxssshdsjQuery, OdsXnxssshdsjPageResult } from "@/api/meta/meta_base/zygxs/ods_xnxssshdsj";
