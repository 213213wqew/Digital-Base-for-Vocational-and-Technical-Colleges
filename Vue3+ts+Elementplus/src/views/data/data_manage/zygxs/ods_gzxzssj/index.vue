  ...
  <div class="professional-certificate-management">
    ...
    <el-card class="table-card" shadow="never">
      <div class="table-header">
        ...
        <div class="header-title">1+X证书数据数据清洗</div>
...
import {
  ...
  getSelectOptions,
  getZyhOptions,
} from "@/api-data/data/data_base/zygxs/ods_gzxzssj";
import type { OdsGzxzssjInfo, OdsGzxzssjQuery } from "@/api-data/data/data_base/zygxs/ods_gzxzssj";
