...
import {
  ...
  type OdsTsjbsjQuery,
  type OdsTsjbsjForm,
} from "@/api-data/data/data_base/zygzc/ods_tsjbsj";
...
const loadDictData = async () => {
  try {
    const [wxlxmRes, zdmRes, zgyzmRes, yzmRes, cbsjbmRes, tsztmRes] = await Promise.all([
      getDictOptions("WXLXDM"), getDictOptions("KWZDDM"), getDictOptions("ZGYZDM"),
      getDictOptions("SJYZDM"), getDictOptions("CBSJBDM"), getDictOptions("TSQKZTDM"),
    ]);
