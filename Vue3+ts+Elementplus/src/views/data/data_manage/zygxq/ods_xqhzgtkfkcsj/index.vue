  ...
  <div class="co-dev-course-management">
    ...
    <el-card class="table-card" shadow="never">
      <div class="table-header">
        ...
        <div class.bind="header-title">校企合作共同开发课程数据清洗</div>
...
} from "@/api-data/data/data_base/zygxq/ods_xqhzgtkfkcsj";
import { getSystemSchoolCode } from "@/api-data/data/data_base/zygxx/ods_xxtsxxhxtyysj";
