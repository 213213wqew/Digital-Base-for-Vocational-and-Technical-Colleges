  ...
  <div class="data-integration-management">
    ...
    <el-card class="table-card" shadow="never">
      <div class="table-header">
        ...
        <div class="header-title">校本数据中心数据集成情况数据数据清洗</div>
...
} from "@/api-data/data/data_base/zygfw/ods_xbsjzxsjjcqksj";
...
const loadDictData = async () => {
  try {
    const [freqRes, methodRes] = await Promise.all([
      getDictOptions('SJBGXPLDM') as any,
      getDictOptions('SJBGXFSDM') as any,
    ]);
