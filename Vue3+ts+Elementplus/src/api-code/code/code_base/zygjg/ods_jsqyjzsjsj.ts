...
export function getOdsJsqyjzsjsjPage(query: OdsJsqyjzsjsjQuery) {
  return request.post<ApiResponse<OdsJsqyjzsjsjPageResult>>(
    "/code/code/code-base/zygjg/ods-jsqyjzsjsj/page",
    query,
  );
}
...
export function getOdsJsqyjzsjsjById(id: number) {
  return request.get<ApiResponse<OdsJsqyjzsjsjInfo>>(
    `/code/code/code-base/zygjg/ods-jsqyjzsjsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsJsqyjzsjsjInfo>>(
    `/code/code/code-base/zygjg/ods-jsqyjzsjsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsJsqyjzsjsj(data: OdsJsqyjzsjsjForm) {
  return request.post<ApiResponse<number>>(
    "/code/code/code-base/zygjg/ods-jsqyjzsjsj/add",
    data,
  );
}
...
export function updateOdsJsqyjzsjsj(data: OdsJsqyjzsjsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/code/code/code-base/zygjg/ods-jsqyjzsjsj/update",
    data,
  );
}
...
export function batchDeleteOdsJsqyjzsjsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/code/code/code-base/zygjg/ods-jsqyjzsjsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsJsqyjzsjsj(query: OdsJsqyjzsjsjQuery) {
  return request.post('/code/code/code-base/zygjg/ods-jsqyjzsjsj/export', query, { responseType: 'blob' });
}
...
export function getOptionsByCode(code: string) {
  return request.get(`/code/code/code-base-source/options/${code}`);
}
...
export function getJsOptions(keyword?: string) {
  ...
  return request.get<ApiResponse<OptionType[]>>(`/code/code/code-base/zygjg/ods-jshxsj/js-options?${params.toString()}`);
}
