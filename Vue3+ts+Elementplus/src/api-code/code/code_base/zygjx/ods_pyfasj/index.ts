...
export function getOdsPyfasjPage(
  ...
  return request.get("/code/code/code-base/zygjx/ods-pyfasj/page", { params });
}
...
export function getOdsPyfasjById(
  ...
  return request.get(`/code/code/code-base/zygjx/ods-pyfasj/${id}`);
}

// 新增培养方案数据
export function addOdsPyfasj(data: OdsPyfasjForm): Promise<ApiResponse<null>> {
  return request.post("/code/code/code-base/zygjx/ods-pyfasj", data);
}
...
export function updateOdsPyfasj(
  ...
  return request.put("/code/code/code-base/zygjx/ods-pyfasj", data);
}

// 删除培养方案数据
export function deleteOdsPyfasj(id: number): Promise<ApiResponse<null>> {
  return request.delete(`/code/code/code-base/zygjx/ods-pyfasj/${id}`);
}
...
export function batchDeleteOdsPyfasj(
  ...
  return request.delete("/code/code/code-base/zygjx/ods-pyfasj", { data: ids });
}

// 导出培养方案数据
export function exportOdsPyfasj(params: OdsPyfasjQuery): Promise<any> {
  return request.post("/code/code/code-base/zygjx/ods-pyfasj/export", params, {
    responseType: "blob",
  });
}
