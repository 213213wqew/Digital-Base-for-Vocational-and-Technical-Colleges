...
export const getOdsXsxfsjPage = (
  ...
  return request.post("/code/code/code-base/zygfw/ods-xsxfsj/page", data);
};
...
export const getOdsXsxfsjById = (
  ...
  return request.get(`/code/code/code-base/zygfw/ods-xsxfsj/${id}`);
};
...
export const getOdsXsxfsjByUniqueId = (
  ...
  return request.get(
    `/code/code/code-base/zygfw/ods-xsxfsj/unique/${zjsjwyxbs}`,
  );
};
...
export const addOdsXsxfsj = (
  ...
  return request.post("/code/code/code-base/zygfw/ods-xsxfsj/add", data);
};
...
export const updateOdsXsxfsj = (
  ...
  return request.put("/code/code/code-base/zygfw/ods-xsxfsj/update", data);
};
...
export const deleteOdsXsxfsj = (id: number): Promise<ApiResponse<boolean>> => {
  return request.delete(`/code/code/code-base/zygfw/ods-xsxfsj/${id}`);
};
...
export const batchDeleteOdsXsxfsj = (
  ...
  return request.delete("/code/code/code-base/zygfw/ods-xsxfsj/batch", ids);
};
...
export const exportOdsXsxfsj = (data: OdsXsxfsjQuery): Promise<Blob> => {
  return request.post("/code/code/code-base/zygfw/ods-xsxfsj/export", data, {
    responseType: "blob",
  });
};
