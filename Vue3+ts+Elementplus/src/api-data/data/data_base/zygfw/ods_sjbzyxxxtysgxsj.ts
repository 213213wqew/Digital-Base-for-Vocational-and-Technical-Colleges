...
export function getOdsSjbzyxxxtysgxsjPage(query: OdsSjbzyxxxtysgxsjQuery) {
  return request.post<ApiResponse<OdsSjbzyxxxtysgxsjPageResult>>(
    "/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/page",
    query,
  );
}
...
export function getOdsSjbzyxxxtysgxsjById(id: number) {
  return request.get<ApiResponse<OdsSjbzyxxxtysgxsjInfo>>(
    `/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsSjbzyxxxtysgxsjInfo>>(
    `/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsSjbzyxxxtysgxsj(data: OdsSjbzyxxxtysgxsjForm) {
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/add",
    data,
  );
}
...
export function updateOdsSjbzyxxxtysgxsj(data: OdsSjbzyxxxtysgxsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/update",
    data,
  );
}
...
export function batchDeleteOdsSjbzyxxxtysgxsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsSjbzyxxxtysgxsj(query: OdsSjbzyxxxtysgxsjQuery) {
  return request.post(
    "/data/data/data-base/zygfw/ods-sjbzyxxxtysgxsj/export",
    query,
    {
      responseType: "blob",
    },
...
export function getSystemSchoolCode() {
  return request.get<ApiResponse<string>>("/data/data/data-base/zygxx/ods-xxhxtjssj/system-school-code");
}
