...
export function listAccessRecord(query: MetaBaseZygxxOdsXxhxtfwjlsjQuery) {
  return request.post<ApiResponse<MetaBaseZygxxOdsXxhxtfwjlsjPageResult>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/page",
    query,
  );
}
...
export function getAccessRecord(id: number) {
  return request.get<ApiResponse<MetaBaseZygxxOdsXxhxtfwjlsjInfo>>(
    `/data/data/data-base/zygxx/ods-xxhxtfwjlsj/${id}`,
  );
}
...
export function getAccessRecordByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<MetaBaseZygxxOdsXxhxtfwjlsjInfo>>(
    `/data/data/data-base/zygxx/ods-xxhxtfwjlsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addAccessRecord(data: MetaBaseZygxxOdsXxhxtfwjlsjForm) {
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/add",
    data,
  );
}
...
/**
 * 批量保存或更新信息化系统访问记录数据（同一天存在则更新，不存在则新增）
 * @param dataList 信息化系统访问记录数据列表
 * @returns 结果
 */
export function batchSaveOrUpdateAccessRecord(dataList: MetaBaseZygxxOdsXxhxtfwjlsjForm[]) {
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/batch-save-or-update",
    dataList,
  );
}
...
export function updateAccessRecord(data: MetaBaseZygxxOdsXxhxtfwjlsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/update",
    data,
  );
}
...
export function batchDeleteAccessRecord(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/batch",
    {
      data: ids,
    },
  );
...
export function getSystemBuildingOptions() {
  return request.get<ApiResponse<SystemBuildingOption[]>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/system-building-options",
  );
}
...
export function exportAccessRecord(query: MetaBaseZygxxOdsXxhxtfwjlsjQuery) {
  return request.post(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/export",
    query,
    {
      responseType: "blob",
...
export function importAccessRecord(formData: FormData) {
  return request.post(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/import",
    formData,
    {
      headers: {
...
export function batchUpdateReportStatus(ids: number[], reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/batch/report-status",
    {
      ids,
      reportStatus,
    },
...
export function batchUpdateEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/batch/enable-status",
    {
      ids,
      enableStatus,
    },
...
export function updateSingleReportStatus(id: number, reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygxx/ods-xxhxtfwjlsj/${id}/report-status`,
    {
      reportStatus,
    },
  );
...
export function updateSingleEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygxx/ods-xxhxtfwjlsj/${id}/enable-status`,
    {
      enableStatus,
    },
  );
...
export const syncYesterdayData = (): Promise<ApiResponse<SyncResult>> => {
  return request.post("/data/data/data-base/zygxx/ods-xxhxtfwjlsj/sync-data");
};
...
export const saveSyncSchedule = (
  ...
  return request.post(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/sync-schedule",
    data,
  );
};
...
/**
 * 批量修改访问记录数据
 * @param modifyParams 修改参数
 * @returns 修改结果
 */
export interface DataModifyParams {
  accessDateRange: string[]; // 访问日期范围
  teacherAccessMin: number; // 教师访问次数最小值
  teacherAccessMax: number; // 教师访问次数最大值
  studentAccessMin: number; // 学生访问次数最小值
  studentAccessMax: number; // 学生访问次数最大值
  collectionTimeUpdate: string; // 采集时间更新方式
}

export function batchModifyAccessRecord(modifyParams: DataModifyParams) {
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygxx/ods-xxhxtfwjlsj/batch-modify",
    modifyParams,
  );
}
