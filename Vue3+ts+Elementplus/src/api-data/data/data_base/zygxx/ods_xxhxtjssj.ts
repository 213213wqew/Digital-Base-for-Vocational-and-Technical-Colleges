...
export function getSystemBuildingDataPage(
  ...
  return request.post<ApiResponse<MetaBaseZygxxOdsXxhxtjssjPageResult>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/page",
    query,
  );
}
...
export function getSystemBuildingDataById(id: number) {
  return request.get<ApiResponse<MetaBaseZygxxOdsXxhxtjssjInfo>>(
    `/data/data/data-base/zygxx/ods-xxhxtjssj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<MetaBaseZygxxOdsXxhxtjssjInfo>>(
    `/data/data/data-base/zygxx/ods-xxhxtjssj/unique/${zjsjwyxbs}`,
  );
}
...
export function addSystemBuildingData(data: MetaBaseZygxxOdsXxhxtjssjForm) {
  ...
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/add",
    data,
  );
}
...
export function updateSystemBuildingData(data: MetaBaseZygxxOdsXxhxtjssjForm) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/update",
    data,
  );
}
...
export function batchDeleteSystemBuildingData(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/batch",
    {
      data: ids,
    },
  );
...
export function exportSystemBuildingData(
  ...
  return request.post("/data/data/data-base/zygxx/ods-xxhxtjssj/export", query, {
    responseType: "blob",
  });
}
...
export function importSystemBuildingData(formData: FormData) {
  return request.post<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/import",
    formData,
    {
      headers: {
...
export function getSystemTypeOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/XXHXTFLDM",
  );
}
...
export function getAccessModeOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/CJJCJRFSDM",
  );
}
...
export function getBuildingTypeOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/XXHXTJSLXDM",
  );
}
...
export function batchUpdateReportStatus(ids: number[], reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/batch/report-status",
    {
      ids,
      reportStatus,
    },
...
export function batchUpdateEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/batch/enable-status",
    {
      ids,
      enableStatus,
    },
...
export function updateSingleReportStatus(id: number, reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygxx/ods-xxhxtjssj/${id}/report-status`,
    {
      reportStatus,
    },
  );
...
export function updateSingleEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygxx/ods-xxhxtjssj/enable-status/${id}`,
    {
      enableStatus,
    },
  );
...
export function fetchSystemBuildingData() {
  return request.post<ApiResponse<SyncResult>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/sync-data",
  );
}
...
export function saveSyncSchedule(schedule: SyncSchedule) {
  return request.post<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/sync-schedule",
    schedule,
  );
}
 ...
 * @returns 操作结果
 */
export function batchUpdateCollectionDate(collectionDate: string, ids: number[]) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygxx/ods-xxhxtjssj/batch/collection-date",
    {
      collectionDate,
      ids
    },
