...
export function getOdsZyjsqksjPage(query: OdsZyjsqksjQuery) {
  return request.get<ApiResponse<OdsZyjsqksjPageResult>>(
    "/data/data/data-base/zygjx/ods-zyjsqksj/page",
    query,
  );
}
...
export function getOdsZyjsqksjById(id: number) {
  return request.get<ApiResponse<OdsZyjsqksjVO>>(
    `/data/data/data-base/zygjx/ods-zyjsqksj/${id}`,
  );
}
...
export function getOdsZyjsqksjByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsZyjsqksjVO>>(
    `/data/data/data-base/zygjx/ods-zyjsqksj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsZyjsqksj(data: OdsZyjsqksjDTO) {
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygjx/ods-zyjsqksj",
    data,
  );
}
...
export function batchDeleteOdsZyjsqksj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyjsqksj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsZyjsqksj(query: OdsZyjsqksjQuery) {
  return request.get("/data/data/data-base/zygjx/ods-zyjsqksj/export", query, {
    responseType: "blob",
  });
}
...
export function updateOdsZyjsqksjReportStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygjx/ods-zyjsqksj/${id}/report-status`,
    null,
    {
      params: { reportStatus },
    },
...
export function updateOdsZyjsqksjEnableStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygjx/ods-zyjsqksj/${id}/enable-status`,
    null,
    {
      params: { enableStatus },
    },
...
export function batchUpdateOdsZyjsqksjReportStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyjsqksj/batch/report-status",
    null,
    {
...
export function batchUpdateOdsZyjsqksjEnableStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyjsqksj/batch/enable-status",
    null,
    {
