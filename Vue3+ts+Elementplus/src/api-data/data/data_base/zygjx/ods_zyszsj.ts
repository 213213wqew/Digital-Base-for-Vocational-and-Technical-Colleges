...
export function getOdsZyszszjPage(query: OdsZyszszjQuery) {
  return request.post<ApiResponse<OdsZyszszjPageResult>>(
    "/data/data/data-base/zygjx/ods-zyszsj/page",
    query,
  );
}
...
export function getOdsZyszszjById(id: number) {
  return request.get<ApiResponse<OdsZyszszjInfo>>(
    `/data/data/data-base/zygjx/ods-zyszsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsZyszszjInfo>>(
    `/data/data/data-base/zygjx/ods-zyszsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsZyszsj(data: OdsZyszszjForm) {
  return request.post<ApiResponse<number>>(
    "/data/data/data-base/zygjx/ods-zyszsj/add",
    data,
  );
}
...
export function updateOdsZyszsj(data: OdsZyszszjForm) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyszsj/update",
    data,
  );
}
...
export function batchDeleteOdsZyszsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyszsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsZyszsj(query: OdsZyszszjQuery) {
  return request.post("/data/data/data-base/zygjx/ods-zyszsj/export", query, {
    responseType: "blob",
  });
}
...
export function getZyccmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/ZYCCDM",
  );
}
...
export function getXzmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/XZDM",
  );
}
...
export function getSyxwlbmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/SYXWLBDM",
  );
}
...
export function getZdzyjbmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/ZDZYJBDM",
  );
}
...
export function getZdzylxmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/data/data/data-base-source/options/ZDZYLXDM",
  );
}
...
export function batchUpdateReportStatus(ids: number[], reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyszsj/batch/report-status",
    {
      ids,
      reportStatus,
    },
...
export function batchUpdateEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/data/data/data-base/zygjx/ods-zyszsj/batch/enable-status",
    {
      ids,
      enableStatus,
    },
...
export function updateSingleReportStatus(id: number, reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygjx/ods-zyszsj/${id}/report-status`,
    {
      reportStatus,
    },
  );
...
export function updateSingleEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/data/data/data-base/zygjx/ods-zyszsj/enable-status/${id}`,
    {
      enableStatus,
    },
  );
...
export function getZyOptions(keyword?: string) {
  const url = keyword
    ? `/data/data/data-base/zygjx/ods-zyszsj/zy-options?keyword=${encodeURIComponent(keyword)}`
