...
export const getOdsXsxfsjPage = (
  ...
  return request.post("/api/meta/meta-base/zygfw/ods-xsxfsj/page", data);
};
...
export const getOdsXsxfsjById = (
  ...
  return request.get(`/api/meta/meta-base/zygfw/ods-xsxfsj/${id}`);
};
...
export const getOdsXsxfsjByUniqueId = (
  ...
  return request.get(
    `/api/meta/meta-base/zygfw/ods-xsxfsj/unique/${zjsjwyxbs}`,
  );
};
...
export const addOdsXsxfsj = (
  ...
  return request.post("/api/meta/meta-base/zygfw/ods-xsxfsj/add", data);
};
...
export const updateOdsXsxfsj = (
  ...
  return request.put("/api/meta/meta-base/zygfw/ods-xsxfsj/update", data);
};
...
export const deleteOdsXsxfsj = (id: number): Promise<ApiResponse<boolean>> => {
  return request.delete(`/api/meta/meta-base/zygfw/ods-xsxfsj/${id}`);
};
...
export const batchDeleteOdsXsxfsj = (
  ...
  return request.delete("/api/meta/meta-base/zygfw/ods-xsxfsj/batch", ids);
};
...
export const exportOdsXsxfsj = (data: OdsXsxfsjQuery): Promise<Blob> => {
  return request.post("/api/meta/meta-base/zygfw/ods-xsxfsj/export", data, {
    responseType: "blob",
  });
};
