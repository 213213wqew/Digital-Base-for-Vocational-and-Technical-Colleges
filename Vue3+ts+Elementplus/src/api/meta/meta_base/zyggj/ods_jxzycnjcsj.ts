...
export function getOdsJxzycnjcsjPage(query: OdsJxzycnjcsjQuery) {
  return request.post<ApiResponse<OdsJxzycnjcsjPageResult>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/page",
    query,
  );
}
...
export function getOdsJxzycnjcsjById(id: number) {
  return request.get<ApiResponse<OdsJxzycnjcsjInfo>>(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsJxzycnjcsjInfo>>(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsJxzycnjcsj(data: OdsJxzycnjcsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/add",
    data,
  );
}
...
export function updateOdsJxzycnjcsj(data: OdsJxzycnjcsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/update",
    data,
  );
}
...
export function batchDeleteOdsJxzycnjcsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsJxzycnjcsj(query: OdsJxzycnjcsjQuery) {
  return request.post(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/export",
    query,
    {
      responseType: "blob",
    },
 ...
 * 下载导入模板
 */
export function downloadImportTemplate(query?: { cyjxzymc?: string; cygjmc?: string }) {
  const params = new URLSearchParams();
  if (query?.cyjxzymc) params.append('cyjxzymc', query.cyjxzymc);
  if (query?.cygjmc) params.append('cygjmc', query.cygjmc);
  
  return request.get(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/template?${params.toString()}`,
    {
      responseType: "blob",
    },
  );
 ...
 * 导入教学资源采纳基础数据
 */
export function importOdsJxzycnjcsj(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<string>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/import",
    formData,
    {
      headers: {
 ...
 * 清空后导入教学资源采纳基础数据
 */
export function importOdsJxzycnjcsjWithClear(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<string>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/import-with-clear",
    formData,
    {
      headers: {
        'Content-Type': 'multipart/form-data',
 ...
 * 预览导入教学资源采纳基础数据
 */
export function previewImportOdsJxzycnjcsj(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<any[]>>(
    "/api/meta/meta-base/zyggj/ods-jxzycnjcsj/preview",
    formData,
    {
      headers: {
        'Content-Type': 'multipart/form-data',
...
export function updateReportStatus(id: number, reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/report-status/${id}?reportStatus=${reportStatus}`,
  );
}
...
export function updateEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/enable-status/${id}?enableStatus=${enableStatus}`,
  );
}
...
export function batchUpdateReportStatus(ids: number[], reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/batch/report-status?reportStatus=${reportStatus}`,
    ids,
  );
}
...
export function batchUpdateEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zyggj/ods-jxzycnjcsj/batch/enable-status?enableStatus=${enableStatus}`,
    ids,
  );
}
