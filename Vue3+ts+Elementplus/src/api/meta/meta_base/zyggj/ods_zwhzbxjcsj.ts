...
export function getOdsZwhzbxjcsjPage(query: OdsZwhzbxjcsjQuery) {
  return request.post<ApiResponse<OdsZwhzbxjcsjPageResult>>(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/page",
    query,
  );
}
...
export function getOdsZwhzbxjcsjById(id: number) {
  return request.get<ApiResponse<OdsZwhzbxjcsjInfo>>(
    `/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsZwhzbxjcsjInfo>>(
    `/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsZwhzbxjcsj(data: OdsZwhzbxjcsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/add",
    data,
  );
}
...
export function updateOdsZwhzbxjcsj(data: OdsZwhzbxjcsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/update",
    data,
  );
}
...
export function batchDeleteOdsZwhzbxjcsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsZwhzbxjcsj(query: OdsZwhzbxjcsjQuery) {
  return request.post(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/export",
    query,
    {
      responseType: "blob",
    },
...
export function downloadTemplate() {
  return request.get(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/template",
    {
      responseType: "blob",
    },
  );
 ...
 * 导入中外合作办学基础数据
 */
export function importCooperationData(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<string>>(
    "/api/meta/meta-base/zyggj/ods-zwhzbxjcsj/import",
    formData,
    {
      headers: {
