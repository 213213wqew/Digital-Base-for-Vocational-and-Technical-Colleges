...
export function pageOdsSxbgjlsj(query: OdsSxbgjlsjQuery) {
  return request.post<ApiResponse<OdsSxbgjlsjPageResult>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/page",
    query,
  );
}
...
export function getOdsSxbgjlsjById(id: number) {
  return request.get<ApiResponse<OdsSxbgjlsjInfo>>(
    `/api/meta/meta-base/zygjx/ods-sxbgjlsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsSxbgjlsjInfo>>(
    `/api/meta/meta-base/zygjx/ods-sxbgjlsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsSxbgjlsj(data: OdsSxbgjlsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/add",
    data,
  );
}
...
export function updateOdsSxbgjlsj(data: OdsSxbgjlsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/update",
    data,
  );
}
...
export function batchDeleteOdsSxbgjlsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsSxbgjlsj(query: OdsSxbgjlsjQuery) {
  return request.post("/api/meta/meta-base/zygjx/ods-sxbgjlsj/export", query, {
    responseType: "blob",
  });
}
 ...
 * @returns 导入结果
 */
export function importOdsSxbgjlsj(file: File) {
  const formData = new FormData();
  formData.append("file", file);
  return request.post<ApiResponse<any>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/import",
    formData,
    {
      headers: {
...
export function getReportTypeOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/SXBGLBDM",
  );
}
...
export function getTeacherReviewStatusOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/JSPYZTDM",
  );
}
...
export function batchUpdateReportStatus(ids: number[], reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/batch/report-status",
    {
      ids,
      status: reportStatus,
    },
...
export function batchUpdateEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygjx/ods-sxbgjlsj/batch/enable-status",
    {
      ids,
      status: enableStatus,
    },
...
export function updateOdsSxbgjlsjReportStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygjx/ods-sxbgjlsj/${id}/report-status`,
    {
      status: reportStatus,
    },
  );
...
export function updateOdsSxbgjlsjEnableStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygjx/ods-sxbgjlsj/${id}/enable-status`,
    {
      status: enableStatus,
    },
  );
