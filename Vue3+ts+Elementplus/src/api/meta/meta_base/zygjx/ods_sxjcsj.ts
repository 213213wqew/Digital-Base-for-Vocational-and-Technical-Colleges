...
export function pageOdsSxjcsj(query: OdsSxjcsjQuery) {
  return request.post<ApiResponse<PageResult<OdsSxjcsjInfo>>>(
    "/api/meta/meta-base/zygjx/ods-sxjcsj/page",
    query,
  );
}
...
export function getOdsSxjcsjById(id: number) {
  return request.get<ApiResponse<OdsSxjcsjInfo>>(
    `/api/meta/meta-base/zygjx/ods-sxjcsj/${id}`,
  );
}
...
export function getOdsSxjcsjByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsSxjcsjInfo>>(
    `/api/meta/meta-base/zygjx/ods-sxjcsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsSxjcsj(data: OdsSxjcsjInfo) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygjx/ods-sxjcsj/add",
    data,
  );
}
...
export function updateOdsSxjcsj(data: OdsSxjcsjInfo) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygjx/ods-sxjcsj/update",
    data,
  );
}
...
export function batchDeleteOdsSxjcsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygjx/ods-sxjcsj/batch",
    { data: ids },
  );
}
...
export function exportOdsSxjcsj(query: OdsSxjcsjQuery) {
  return request.post("/api/meta/meta-base/zygjx/ods-sxjcsj/export", query, {
    responseType: "blob",
    timeout: 60000, // 60秒超时
  });
}
...
export function updateOdsSxjcsjReportStatus(id: number, reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygjx/ods-sxjcsj/report-status/${id}?reportStatus=${reportStatus}`,
  );
}
...
export function updateOdsSxjcsjEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygjx/ods-sxjcsj/enable-status/${id}?enableStatus=${enableStatus}`,
  );
}
...
export function batchUpdateOdsSxjcsjReportStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygjx/ods-sxjcsj/batch/report-status?reportStatus=${reportStatus}`,
    ids,
  );
}
...
export function batchUpdateOdsSxjcsjEnableStatus(
  ...
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygjx/ods-sxjcsj/batch/enable-status?enableStatus=${enableStatus}`,
    ids,
  );
}
...
export function downloadTemplate() {
  return request.get(
    "/api/meta/meta-base/zygjx/ods-sxjcsj/template",
    {
      responseType: "blob",
    },
  );
 ...
 * 导入实习基础数据
 */
export function importInternshipData(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<string>>(
    "/api/meta/meta-base/zygjx/ods-sxjcsj/import",
    formData,
    {
      headers: {
