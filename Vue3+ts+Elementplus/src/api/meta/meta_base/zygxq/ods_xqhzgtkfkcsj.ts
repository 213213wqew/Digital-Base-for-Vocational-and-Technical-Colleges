...
export function getOdsXqhzgtkfkcsjPage(query: OdsXqhzgtkfkcsjQuery) {
  return request.post<ApiResponse<OdsXqhzgtkfkcsjPageResult>>(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/page",
    query,
  );
}
...
export function getOdsXqhzgtkfkcsjById(id: number) {
  return request.get<ApiResponse<OdsXqhzgtkfkcsjInfo>>(
    `/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsXqhzgtkfkcsjInfo>>(
    `/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsXqhzgtkfkcsj(data: OdsXqhzgtkfkcsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/add",
    data,
  );
}
...
export function updateOdsXqhzgtkfkcsj(data: OdsXqhzgtkfkcsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/update",
    data,
  );
}
...
export function batchDeleteOdsXqhzgtkfkcsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsXqhzgtkfkcsj(query: OdsXqhzgtkfkcsjQuery) {
  return request.post(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/export",
    query,
    {
      responseType: "blob",
    },
...
export function searchCxhzCompanies(companyName: string) {
  return request.get<ApiResponse<OdsCxhzCompanyInfo[]>>(
    "/api/meta/meta-base/zygxq/ods-cxhzsj/search",
    {
       companyName ,
    },
  );
 ...
 * 下载导入模板
 */
export function downloadImportTemplate(query?: { kcmc?: string; hzqymc?: string }) {
  const params = new URLSearchParams();
  if (query?.kcmc) params.append('kcmc', query.kcmc);
  if (query?.hzqymc) params.append('hzqymc', query.hzqymc);
  
  return request.get(
    `/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/template?${params.toString()}`,
    {
      responseType: "blob",
    },
  );
 ...
 * 导入校企合作共同开发课程数据
 */
export function importOdsXqhzgtkfkcsj(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<string>>(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/import",
    formData,
    {
      headers: {
 ...
 * 清空后导入校企合作共同开发课程数据
 */
export function importOdsXqhzgtkfkcsjWithClear(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  
  return request.post<ApiResponse<string>>(
    "/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/import-with-clear",
    formData,
    {
      headers: {
        'Content-Type': 'multipart/form-data',
...
export function updateEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/enable-status/${id}?enableStatus=${enableStatus}`,
  );
}
...
export function batchUpdateReportStatus(ids: number[], reportStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/batch/report-status?reportStatus=${reportStatus}`,
    ids,
  );
}
...
export function batchUpdateEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygxq/ods-xqhzgtkfkcsj/batch/enable-status?enableStatus=${enableStatus}`,
    ids,
  );
}
