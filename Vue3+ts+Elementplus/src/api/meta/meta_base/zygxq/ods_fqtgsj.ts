...
export function getOdsFqtgsjPage(query: OdsFqtgsjQuery) {
  return request.post<ApiResponse<OdsFqtgsjPageResult>>(
    "/api/meta/meta-base/zygxq/ods-fqtgsj/page",
    query,
  );
}
...
export function getOdsFqtgsjById(id: number) {
  return request.get<ApiResponse<OdsFqtgsjInfo>>(
    `/api/meta/meta-base/zygxq/ods-fqtgsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsFqtgsjInfo>>(
    `/api/meta/meta-base/zygxq/ods-fqtgsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsFqtgsj(data: OdsFqtgsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygxq/ods-fqtgsj/add",
    data,
  );
}
...
export function updateOdsFqtgsj(data: OdsFqtgsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygxq/ods-fqtgsj/update",
    data,
  );
}
...
export function batchDeleteOdsFqtgsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygxq/ods-fqtgsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsFqtgsj(query: OdsFqtgsjQuery) {
  return request.post("/api/meta/meta-base/zygxq/ods-fqtgsj/export", query, {
    responseType: "blob",
  });
}
 ...
 * 导入访企拓岗数据
 */
export function importOdsFqtgsj(file: File) {
  const formData = new FormData();
  formData.append('file', file);
  return request.post<ApiResponse<any>>(
    "/api/meta/meta-base/zygxq/ods-fqtgsj/import",
    formData,
    {
      headers: {
