...
export function getOdsDzzqkjcsjPage(query: OdsDzzqkjcsjQuery) {
  return request.post<ApiResponse<OdsDzzqkjcsjPageResult>>(
    "/api/meta/meta-base/zygdz/ods-dzzqkjcsj/page",
    query,
  );
}
...
export function getOdsDzzqkjcsjById(id: number) {
  return request.get<ApiResponse<OdsDzzqkjcsjInfo>>(
    `/api/meta/meta-base/zygdz/ods-dzzqkjcsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsDzzqkjcsjInfo>>(
    `/api/meta/meta-base/zygdz/ods-dzzqkjcsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsDzzqkjcsj(data: OdsDzzqkjcsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygdz/ods-dzzqkjcsj/add",
    data,
  );
}
...
export function updateOdsDzzqkjcsj(data: OdsDzzqkjcsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygdz/ods-dzzqkjcsj/update",
    data,
  );
}
...
export function batchDeleteOdsDzzqkjcsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygdz/ods-dzzqkjcsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsDzzqkjcsj(query: OdsDzzqkjcsjQuery) {
  return request.post("/api/meta/meta-base/zygdz/ods-dzzqkjcsj/export", query, {
    responseType: "blob",
  });
}
// 字典选项（后端返回格式）
...
export function getDzzlxmDict() {
  return request.get<ApiResponse<DictOption[]>>("/api/meta/data-base-source/options/DZZLXDM");
}
//党组织状态码字典
export function getDzzztDict() {
  return request.get<ApiResponse<DictOption[]>>("/api/meta/data-base-source/options/DZZZTDM");
}
//党内领导职务码字典
export function getDnldzwmDict() {
  return request.get<ApiResponse<DictOption[]>>("/api/meta/data-base-source/options/DNLDRYZWDM");
}
