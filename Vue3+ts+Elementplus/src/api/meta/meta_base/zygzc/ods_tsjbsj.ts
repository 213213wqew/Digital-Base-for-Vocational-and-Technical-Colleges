...
export function getOdsTsjbsjPage(query: OdsTsjbsjQuery) {
  return request.post<ApiResponse<OdsTsjbsjPageResult>>(
    "/api/meta/meta-base/zygzc/ods-tsjbsj/page",
    query,
  );
}
...
export function getOdsTsjbsjById(id: number) {
  return request.get<ApiResponse<OdsTsjbsjInfo>>(
    `/api/meta/meta-base/zygzc/ods-tsjbsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsTsjbsjInfo>>(
    `/api/meta/meta-base/zygzc/ods-tsjbsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsTsjbsj(data: OdsTsjbsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygzc/ods-tsjbsj/add",
    data,
  );
}
...
export function updateOdsTsjbsj(data: OdsTsjbsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-tsjbsj/update",
    data,
  );
}
...
export function batchDeleteOdsTsjbsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-tsjbsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsTsjbsj(query: OdsTsjbsjQuery) {
  return request.post("/api/meta/meta-base/zygzc/ods-tsjbsj/export", query, {
    responseType: "blob",
  });
}
...
export function getDictWxlxm() {
  return request.get<ApiResponse<DictOption[]>>("/api/system/dict/data/WXLXDM");
}
...
export function getDictZdm() {
  return request.get<ApiResponse<DictOption[]>>("/api/system/dict/data/ZDDM");
}
...
export function getDictZgyzm() {
  return request.get<ApiResponse<DictOption[]>>("/api/system/dict/data/ZGYZDM");
}
...
export function getDictYzm() {
  return request.get<ApiResponse<DictOption[]>>("/api/system/dict/data/YZDM");
}
...
export function getDictTsztm() {
  return request.get<ApiResponse<DictOption[]>>("/api/system/dict/data/TSZTDM");
}
