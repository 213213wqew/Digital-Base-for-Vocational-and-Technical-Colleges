...
export function getOdsYqsbjbsjPage(query: OdsYqsbjbsjQuery) {
  return request.post<ApiResponse<OdsYqsbjbsjPageResult>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/page",
    query,
  );
}
...
export function getOdsYqsbjbsjById(id: number) {
  return request.get<ApiResponse<OdsYqsbjbsjInfo>>(
    `/api/meta/meta-base/zygzc/ods-yqsbjbsj/${id}`,
  );
}
...
export function getByUniqueId(zjsjwyxbs: string) {
  return request.get<ApiResponse<OdsYqsbjbsjInfo>>(
    `/api/meta/meta-base/zygzc/ods-yqsbjbsj/unique/${zjsjwyxbs}`,
  );
}
...
export function addOdsYqsbjbsj(data: OdsYqsbjbsjForm) {
  return request.post<ApiResponse<number>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/add",
    data,
  );
}
...
export function updateOdsYqsbjbsj(data: OdsYqsbjbsjForm) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/update",
    data,
  );
}
...
export function batchDeleteOdsYqsbjbsj(ids: number[]) {
  return request.delete<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/batch",
    {
      data: ids,
    },
  );
...
export function exportOdsYqsbjbsj(query: OdsYqsbjbsjQuery) {
  return request.post("/api/meta/meta-base/zygzc/ods-yqsbjbsj/export", query, {
    responseType: "blob",
  });
}
...
export function getOdsYqsbjbsjList(query: OdsYqsbjbsjQuery) {
  return request.post<ApiResponse<OdsYqsbjbsjInfo[]>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/list",
    query
  );
}
...
export function reportOdsYqsbjbsj(ids: number[]) {
  return request.post<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/report",
    ids
  );
}
...
export function toggleEnableStatus(id: number, enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    `/api/meta/meta-base/zygzc/ods-yqsbjbsj/toggle-status/${id}/${enableStatus}`
  );
}
...
export function batchToggleEnableStatus(ids: number[], enableStatus: string) {
  return request.put<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/batch-toggle-status",
    {
      ids,
      enableStatus
    }
...
export function importOdsYqsbjbsj(file: File) {
  ...
  return request.post<ApiResponse<boolean>>(
    "/api/meta/meta-base/zygzc/ods-yqsbjbsj/import",
    formData,
    {
      headers: {
...
export function downloadTemplate() {
  return request.get("/api/meta/meta-base/zygzc/ods-yqsbjbsj/template", {
    responseType: "blob"
  });
}
...
export function getXxdwccmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/XXDWCCDM",
  );
}
...
export function getCqmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/CQDM",
  );
}
...
export function getSyzkmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/SYZKDM",
  );
}
...
export function getGxzcflmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/GDXXGDZCFLYDM",
  );
}
...
export function getScgbdqmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/SJGGHDQMCDM",
  );
}
...
export function getJfkmmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/JFKMDM",
  );
}
...
export function getJgbzOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/HBHZJDM",
  );
}
...
export function getSblymOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/SBLYDM",
  );
}
...
export function getZcjcflmOptions() {
  return request.get<ApiResponse<DictOption[]>>(
    "/api/meta/data-base-source/options/GDZCDZCJCFLYDM",
  );
}
